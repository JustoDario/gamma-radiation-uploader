...
for path in sys.path:
    print(f"  {path}")
print("=== Fin información de depuración ===\n")

try:
    from radiacode import RadiaCode
    print(f"RadiaCode importado correctamente desde: {RadiaCode.__module__}")
except ImportError as e:
    print(f"Error importando RadiaCode: {str(e)}")
    print("\nBuscando el módulo radiacode en el sistema:")
    
    # Buscar el módulo en las rutas de Python
    import glob
